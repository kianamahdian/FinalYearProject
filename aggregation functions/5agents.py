...
def opinion_first(stances, relationships):
    ...
    if result == 'neutral':  # Use relationships to resolve ties
...
def load_data(agents_file, relationships_file):
    ...
    # Load the second dataset (relationships between agents)
...
norms, relationships = load_data(
    '/Users/kiana/Desktop/projectkarshenasi/norms_and_stances_5_agents.csv',
    '/Users/kiana/Desktop/projectkarshenasi/output2.csv'
)
